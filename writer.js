		...
		function( conn )
		{
			...
			for ( var i = 0; i < objUnit.authors.length; i++ )
			{
				...
				if ( definition )
				{
					...
					(
						arrQueries,
						"INSERT " + conn.getIgnore() + " INTO definitions (definition_chash, definition, has_references) VALUES (?,?,?)",
						[
							definition_chash,
					...
					if ( message.payload_location === "inline" )
					{
						...
						case "data_feed":
							...
							for ( var feed_name in data )
							{
								...
								(
									arrQueries,
									"INSERT INTO data_feeds (unit, message_index, feed_name, " + field_name + ") VALUES(?,?,?,?)",
									[
										objUnit.unit,
										i,
										feed_name,
